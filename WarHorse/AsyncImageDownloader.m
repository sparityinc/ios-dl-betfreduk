...
-(void)startDownload
{
    ...
    if (fileURL)
        request = [NSURLRequest requestWithURL:[NSURL URLWithString:fileURL] cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:60.0];
    else
        request = [NSURLRequest requestWithURL:[NSURL URLWithString:mediaURL] cachePolicy:NSURLRequestReloadIgnoringLocalCacheData timeoutInterval:60.0];
